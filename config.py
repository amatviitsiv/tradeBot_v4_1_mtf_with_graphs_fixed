...
RISK_PER_TRADE = 0.022                # 2.4% от equity (BTC-only aggressive sizing)
...
SYMBOL_PARAM_OVERRIDES = {
    "BTCUSDT": {
        ...
        "CONTINUATION_MIN_HTF_ADX": 20.0,
        "CONTINUATION_MIN_VOL_RATIO": 0.91,
        ...
        "V7_DIRECT_BOOST_MULT": 1.54,
        "V7_DIRECT_BOOST_MIN_ADX": 26.0,
        "V7_DIRECT_BOOST_MIN_DRIFT_PCT": 0.0070,
    },
    "ETHUSDT": {
...
V52_MR_SYMBOLS = ["BTCUSDT", "ETHUSDT"]
...
V22_RECLAIM_RISK_MULTIPLIER_BTC = 0.34
...
V22_RECLAIM_MAX_HTF_ADX_BTC = 20.5
V22_RECLAIM_MAX_HTF_ADX_ETH = 18.0
V22_RECLAIM_MAX_DRIFT_PCT_BTC = 0.0044
V22_RECLAIM_MAX_DRIFT_PCT_ETH = 0.0038
V22_RECLAIM_MIN_VOL_RATIO_BTC = 0.98
V22_RECLAIM_MIN_VOL_RATIO_ETH = 1.02
V22_RECLAIM_MIN_BODY_ATR_BTC = 0.20
V22_RECLAIM_MIN_BODY_ATR_ETH = 0.24
V22_RECLAIM_MIN_CLOSE_POS_BTC = 0.60
...
V22_RECLAIM_MIN_EMA20_RECLAIM_PCT_BTC = 0.0008
V22_RECLAIM_MIN_EMA20_RECLAIM_PCT_ETH = 0.0012
V22_RECLAIM_RSI_MIN_BTC = 44.0
V22_RECLAIM_RSI_MAX_BTC = 56.0
V22_RECLAIM_RSI_MIN_ETH = 45.0
V22_RECLAIM_RSI_MAX_ETH = 55.0
V22_RECLAIM_HTF_RSI_MIN_BTC = 48.0
V22_RECLAIM_HTF_RSI_MIN_ETH = 50.0

# v23 selective non-trend guards
V23_MR_MAX_HTF_ADX_BTC = 18.5
V23_MR_MAX_HTF_ADX_ETH = 15.5
V23_MR_MAX_DRIFT_PCT_BTC = 0.0036
V23_MR_MAX_DRIFT_PCT_ETH = 0.0028
V23_MR_MAX_VOL_RATIO_BTC = 1.08
V23_MR_MAX_VOL_RATIO_ETH = 1.02
V23_MR_MAX_BODY_ATR = 0.42
V23_MR_RISK_MULT_BTC = 0.92
...
V25_MAX_RISK_PER_TRADE = 0.0280
V25_BTC_VERY_STRONG_MIN_EXEC_MULT = 2.30
V25_BTC_VERY_STRONG_RISK_MULT = 1.40
V25_BTC_STRONG_MIN_EXEC_MULT = 1.75
V25_BTC_STRONG_RISK_MULT = 1.20
...
V25_BTC_STRONG_CONT_RISK_MULT = 1.04
V25_BTC_WEAK_MAX_EXEC_MULT = 1.05
V25_BTC_WEAK_MIN_IMPULSE = 0.72
V25_BTC_WEAK_RISK_MULT = 0.42
