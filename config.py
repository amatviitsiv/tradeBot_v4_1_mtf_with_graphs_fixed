...
SYMBOL_PARAM_OVERRIDES = {
    ...
    "ETHUSDT": {
        ...
        "POSITION_TP1_ATR_MULT_RANGE": 3.0,
        "POSITION_TP1_CLOSE_FRACTION_RANGE": 0.50,
...
POSITION_EARLY_EXIT_BARS_CONTINUATION = 9
POSITION_EARLY_EXIT_MIN_PROGRESS_ATR_CONTINUATION = 0.28
...
POSITION_EARLY_CUT_LOSS_ATR_CONTINUATION = 1.45
POSITION_EARLY_CUT_MAX_PROGRESS_ATR_CONTINUATION = 0.15
...
POSITION_TP1_ATR_MULT_RANGE = 1.6
POSITION_TP1_CLOSE_FRACTION_RANGE = 0.75
POSITION_BE_TRIGGER_ATR_RANGE = 0.55
POSITION_BE_OFFSET_ATR_RANGE = 0.03
POSITION_TRAILING_ACTIVATION_ATR_RANGE = 1.9
POSITION_TRAILING_ATR_MULT_RANGE = 1.4
POSITION_TRAILING_STEP_ATR_RANGE = 0.08
POSITION_TIME_STOP_BEFORE_TP1_BARS_RANGE = 8
POSITION_TIME_STOP_AFTER_TP1_BARS_RANGE = 4
POSITION_INITIAL_SL_ATR_MULT_RANGE = 1.15

POSITION_TP1_ATR_MULT_CONTINUATION = 5.4
POSITION_TP1_CLOSE_FRACTION_CONTINUATION = 0.18
POSITION_BE_TRIGGER_ATR_CONTINUATION = 1.5
POSITION_BE_OFFSET_ATR_CONTINUATION = 0.08
POSITION_TRAILING_ACTIVATION_ATR_CONTINUATION = 4.4
POSITION_TRAILING_ATR_MULT_CONTINUATION = 3.0
POSITION_TRAILING_STEP_ATR_CONTINUATION = 0.10
...
POSITION_INITIAL_SL_ATR_MULT_CONTINUATION = 3.2
