...
SYMBOL_PARAM_OVERRIDES = {
    ...
    "ETHUSDT": {
        ...
        "ENABLE_CONT_COMP": 0,
        "ENABLE_FAKEOUT": 0,
        "ALT_V2_LONG_MIN_ALT_SCORE": 0.49,
        "ALT_V2_LONG_MIN_RS_RATIO": 1.0018,
        "ALT_V2_LONG_MIN_ADX": 19.0,
        "ALT_V2_LONG_MIN_DRIFT_PCT": 0.0046,
        "ALT_V2_LONG_MIN_VOLUME_IMPULSE": 0.52,
    ...
    "SOLUSDT": {
        ...
        "ENABLE_CONT_COMP": 1,
        "ENABLE_FAKEOUT": 1,
        "ALT_V1_CONT_SHORT_MIN_BTC_SCORE": 1.06,
        "ALT_V1_CONT_SHORT_MAX_RS_RATIO": 0.9980,
        "ALT_V1_CONT_SHORT_REQUIRE_STRONG_SETUP": 0,
        "ALT_V2_SHORT_MIN_BTC_SCORE": 1.05,
        "ALT_V2_SHORT_MIN_ALT_SCORE": 0.53,
        "ALT_V2_SHORT_MAX_RS_RATIO": 0.9983,
        "ALT_V2_SHORT_MIN_ADX": 21.5,
        "ALT_V2_SHORT_MIN_DRIFT_PCT": 0.0054,
        "ALT_V2_SHORT_MIN_VOLUME_IMPULSE": 0.54,
        "ALT_V2_SHORT_REQUIRE_STRONG_SETUP": 0,
        "ALT_V2_SHORT_ALLOW_TRANSITION": 1,
        "ALT_V2_SHORT_BLOCK_SOFT_PASSES": 0,
        "ALT_V2_LONG_BLOCK_SOFT_PASSES": 0,
        "ALT_V2_LONG_ALLOW_TRANSITION_STRONG_SETUP": 1,
        "ALT_V2_LONG_MIN_RS_RATIO": 1.0018,
        "ALT_V2_LONG_MIN_ADX": 19.0,
        "ALT_V2_LONG_MIN_DRIFT_PCT": 0.0046,
        "ALT_V2_LONG_MIN_VOLUME_IMPULSE": 0.50,
    },
    "BNBUSDT": {
        ...
        "ENABLE_CONT_COMP": 1,
        "ENABLE_FAKEOUT": 1,
        "ALT_V1_CONT_SHORT_MIN_BTC_SCORE": 1.07,
        "ALT_V1_CONT_SHORT_MAX_RS_RATIO": 0.9980,
        "ALT_V1_CONT_SHORT_REQUIRE_STRONG_SETUP": 0,
        "ALT_V2_SHORT_MIN_BTC_SCORE": 1.05,
        "ALT_V2_SHORT_MIN_ALT_SCORE": 0.53,
        "ALT_V2_SHORT_MAX_RS_RATIO": 0.9982,
        "ALT_V2_SHORT_MIN_ADX": 22.0,
        "ALT_V2_SHORT_MIN_DRIFT_PCT": 0.0056,
        "ALT_V2_SHORT_MIN_VOLUME_IMPULSE": 0.53,
        "ALT_V2_SHORT_REQUIRE_STRONG_SETUP": 0,
        "ALT_V2_SHORT_ALLOW_TRANSITION": 1,
        "ALT_V2_SHORT_BLOCK_SOFT_PASSES": 0,
        "ALT_V2_LONG_BLOCK_SOFT_PASSES": 0,
    ...
    "AVAXUSDT": {
        ...
        "ENABLE_CONT_COMP": 1,
        "ENABLE_FAKEOUT": 1,
        "ALT_V1_CONT_SHORT_MIN_BTC_SCORE": 1.08,
        "ALT_V1_CONT_SHORT_MAX_RS_RATIO": 0.9978,
        "ALT_V1_CONT_SHORT_REQUIRE_STRONG_SETUP": 0,
        "ALT_V2_SHORT_MIN_BTC_SCORE": 1.07,
        "ALT_V2_SHORT_MIN_ALT_SCORE": 0.54,
        "ALT_V2_SHORT_MAX_RS_RATIO": 0.9980,
        "ALT_V2_SHORT_MIN_ADX": 22.5,
        "ALT_V2_SHORT_MIN_DRIFT_PCT": 0.0058,
        "ALT_V2_SHORT_MIN_VOLUME_IMPULSE": 0.55,
        "ALT_V2_SHORT_REQUIRE_STRONG_SETUP": 0,
        "ALT_V2_SHORT_ALLOW_TRANSITION": 1,
        "ALT_V2_SHORT_BLOCK_SOFT_PASSES": 0,
        "ALT_V2_LONG_BLOCK_SOFT_PASSES": 0,
        "ALT_V2_LONG_ALLOW_TRANSITION_STRONG_SETUP": 1,
        "ALT_V2_LONG_MIN_RS_RATIO": 1.0019,
        "ALT_V2_LONG_MIN_ADX": 19.5,
        "ALT_V2_LONG_MIN_DRIFT_PCT": 0.0048,
        "ALT_V2_LONG_MIN_VOLUME_IMPULSE": 0.52,
    },
}
...
V7_DIRECT_BOOST_MIN_ADX = 24.0
V7_DIRECT_BOOST_MIN_DRIFT_PCT = 0.0060
V7_DIRECT_BOOST_MIN_IMPULSE = 0.75
V7_DIRECT_BOOST_REQUIRES_STRONG_SETUP = True
V7_DIRECT_BOOST_MULT = 1.45

V78_SELECTIVE_RISK_ENABLED = True
...
V78_RISK_MILD_MULT = 0.90
V78_RISK_SEVERE_MULT = 0.78
V78_STRONG_SETUP_MILD_MULT = 0.96
V78_STRONG_SETUP_SEVERE_MULT = 0.88
...
V80_ALT_ENGINE_ENABLED = True
V80_ALT_ENGINE_ALLOWED_TYPES = ["impulse", "continuation", "cont_compression"]
V80_ALT_MIN_BTC_SCORE = 0.98
V80_ALT_MIN_ALT_SCORE = 0.98
V80_ALT_LONG_MIN_RS_RATIO = 1.00
V80_ALT_SHORT_MAX_RS_RATIO = 1.00
V80_ALT_MIN_ADX = 18.0
V80_ALT_MIN_DRIFT_PCT = 0.0035
V80_ALT_MIN_IMPULSE_SCORE = 0.62
V80_ALT_WEAK_RISK_MULT = 0.86
V80_ALT_NORMAL_RISK_MULT = 0.95
V80_ALT_STRONG_RISK_MULT = 1.04
V80_ALT_STRONG_MIN_BTC_SCORE = 1.08
V80_ALT_STRONG_MIN_ALT_SCORE = 1.08
V80_ALT_STRONG_MIN_IMPULSE_SCORE = 0.90
V80_ALT_STRONG_MIN_ADX = 24.0
...
V83_SHORT_SUPPRESSION_SYMBOLS = ["BTCUSDT", "ETHUSDT"]
...
V85_INLINE_SHORT_SUPPRESSION_SYMBOLS = ["BTCUSDT", "ETHUSDT"]
...
V86_INLINE_LONG_SUPPRESSION_SYMBOLS = ["BTCUSDT", "ETHUSDT"]
...
ALT_CONTINUATION_ALLOW_IN_RANGE = True
...
ALT_FINAL_ENTRY_EXECUTION_RISK_MULT = 0.58
ALT_FORCE_EXEC_MIN_ADX_H = 15.0
ALT_FORCE_EXEC_MIN_DRIFT = 0.02
ALT_FORCE_EXEC_MIN_IMPULSE_SCORE = 0.095
ALT_LATE_ENTRY_IMPROVEMENT_ALLOW = True
ALT_LATE_ENTRY_SYMBOLS = ["SOLUSDT", "BNBUSDT", "AVAXUSDT"]
ALT_LATE_ENTRY_MAX_TRIGGER_DIST_PCT = 0.0025
ALT_LATE_ENTRY_MIN_DRIFT = 0.03
ALT_LATE_ENTRY_MAX_RSI_SHORT = 32.0
ALT_LATE_ENTRY_MIN_ADX_H = 17.0
ALT_LATE_ENTRY_MIN_IMPULSE_SCORE = 0.14
ALT_LATE_ENTRY_RISK_MULT = 0.70
