...
STRONG_SETUP_RISK_MULT = 1.35
VERY_STRONG_SETUP_RISK_MULT = 1.70
STRONG_SETUP_MIN_ADX = 27.0
VERY_STRONG_SETUP_MIN_ADX = 34.0
STRONG_SETUP_MIN_DRIFT_PCT = 0.0080
VERY_STRONG_SETUP_MIN_DRIFT_PCT = 0.0120
STRONG_SETUP_MIN_VOLUME_IMPULSE = 0.90
VERY_STRONG_SETUP_MIN_VOLUME_IMPULSE = 1.05
...
ALT_REV_MIN_STRETCH_ATR = 1.35
ALT_REV_RSI_LONG_MAX = 34.0
ALT_REV_RSI_SHORT_MIN = 66.0
ALT_REV_MIN_CLOSE_POS_LONG = 0.45
ALT_REV_MAX_CLOSE_POS_SHORT = 0.55
ALT_REV_MIN_BODY_RATIO = 0.18
ALT_REV_MIN_VOL_RATIO = 0.90
ALT_REV_RISK_MULTIPLIER = 0.60
POSITION_INITIAL_SL_ATR_MULT_ALT_REVERSION = 2.6
POSITION_TP1_ATR_MULT_ALT_REVERSION = 1.7
POSITION_TP1_CLOSE_FRACTION_ALT_REVERSION = 1.0
POSITION_TIME_STOP_BEFORE_TP1_BARS_ALT_REVERSION = 10
