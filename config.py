...
SYMBOL_PARAM_OVERRIDES = {
    "BTCUSDT": {
        ...
        "REL_STRENGTH_MIN_RATIO": 1.0,
        "REL_STRENGTH_SHORT_MAX_RATIO": 1.0,
    },
    "ETHUSDT": {
        ...
        "ALT_QUALITY_MIN_SCORE": 0.58,
        "IMPULSE_BREAKOUT_MIN_BODY_ATR": 0.80,
        "IMPULSE_BREAKOUT_MIN_RANGE_ATR": 1.15,
        "IMPULSE_BREAKOUT_MIN_EXCURSION_ATR": 0.16,
        "REL_STRENGTH_MIN_RATIO": 1.003,
        "REL_STRENGTH_SHORT_MAX_RATIO": 0.997,
        "RANGE_RSI_LONG_MAX": 30.0,
        "RANGE_RSI_SHORT_MIN": 70.0,
    ...
    "SOLUSDT": {
        ...
        "ALT_QUALITY_MIN_SCORE": 0.62,
        "BREAKOUT_CONFIRM_BUFFER_ATR": 0.18,
        "BREAKOUT_HOLD_BUFFER_ATR": 0.10,
        "RANGE_ENTRY_ZONE_ATR": 1.00,
        "IMPULSE_BREAKOUT_MIN_BODY_ATR": 0.95,
        "IMPULSE_BREAKOUT_MIN_RANGE_ATR": 1.35,
        "IMPULSE_BREAKOUT_MIN_EXCURSION_ATR": 0.24,
        "REL_STRENGTH_MIN_RATIO": 1.006,
        "REL_STRENGTH_SHORT_MAX_RATIO": 0.994,
        "RANGE_RSI_LONG_MAX": 28.0,
        "RANGE_RSI_SHORT_MIN": 72.0,
        "RANGE_MIN_STRETCH_FROM_MEAN_ATR": 1.50,
    ...
    "BNBUSDT": {
        ...
        "ALT_QUALITY_MIN_SCORE": 0.57,
        "BREAKOUT_CONFIRM_BUFFER_ATR": 0.16,
        "BREAKOUT_HOLD_BUFFER_ATR": 0.08,
        "IMPULSE_BREAKOUT_MIN_BODY_ATR": 0.88,
        "IMPULSE_BREAKOUT_MIN_RANGE_ATR": 1.22,
        "IMPULSE_BREAKOUT_MIN_EXCURSION_ATR": 0.20,
        "REL_STRENGTH_MIN_RATIO": 1.004,
        "REL_STRENGTH_SHORT_MAX_RATIO": 0.996,
        "RANGE_RSI_LONG_MAX": 30.0,
        "RANGE_RSI_SHORT_MIN": 70.0,
        "RANGE_MIN_STRETCH_FROM_MEAN_ATR": 1.35,
    ...
    "AVAXUSDT": {
        ...
        "ALT_QUALITY_MIN_SCORE": 0.64,
        "BREAKOUT_CONFIRM_BUFFER_ATR": 0.20,
        "BREAKOUT_HOLD_BUFFER_ATR": 0.12,
        "RANGE_ENTRY_ZONE_ATR": 1.10,
        "IMPULSE_BREAKOUT_MIN_BODY_ATR": 1.00,
        "IMPULSE_BREAKOUT_MIN_RANGE_ATR": 1.40,
        "IMPULSE_BREAKOUT_MIN_EXCURSION_ATR": 0.26,
        "REL_STRENGTH_MIN_RATIO": 1.008,
        "REL_STRENGTH_SHORT_MAX_RATIO": 0.992,
        "RANGE_RSI_LONG_MAX": 27.0,
        "RANGE_RSI_SHORT_MIN": 73.0,
        "RANGE_MIN_STRETCH_FROM_MEAN_ATR": 1.60,
...
BTC_REGIME_MIN_SCORE = 0.80
BTC_REGIME_MIN_SCORE_LONG = 0.78
BTC_REGIME_MIN_SCORE_SHORT = 1.10
...
RANGE_RSI_LONG_MAX = 32.0
RANGE_RSI_SHORT_MIN = 68.0
RANGE_MIN_BOUNCE_BODY_ATR = 0.28
RANGE_MIN_STRETCH_FROM_MEAN_ATR = 1.25
RANGE_BOUNCE_MIN_CLOSE_POS = 0.58
RANGE_ENTRY_ADX_MAX = 17.0
...
IMPULSE_BREAKOUT_MIN_BODY_ATR = 0.85
IMPULSE_BREAKOUT_MIN_RANGE_ATR = 1.20
IMPULSE_BREAKOUT_MIN_EXCURSION_ATR = 0.18
IMPULSE_BREAKOUT_MIN_CLOSE_POS = 0.68
IMPULSE_BREAKOUT_MIN_ATR_EXPANSION = 1.02

# Relative strength против BTC для альтов.
REL_STRENGTH_LOOKBACK = 48
REL_STRENGTH_EMA = 34
REL_STRENGTH_MIN_RATIO = 1.002
REL_STRENGTH_MIN_SLOPE = 0.0
REL_STRENGTH_SHORT_MAX_RATIO = 0.998
...
MARKET_STATE_TRANSITION_FALSE_BREAKOUT_MIN = 0.58
MARKET_STATE_TRANSITION_WICKINESS_MIN = 0.62
