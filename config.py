...
POSITION_TP1_ATR_MULT_TREND = 8.0
POSITION_TP1_CLOSE_FRACTION_TREND = 0.25
POSITION_BE_TRIGGER_ATR_TREND = 3.0
POSITION_BE_OFFSET_ATR_TREND = 0.12
POSITION_TRAILING_ACTIVATION_ATR_TREND = 8.0
POSITION_TRAILING_ATR_MULT_TREND = 5.4
POSITION_TRAILING_STEP_ATR_TREND = 0.40
