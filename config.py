...
SYMBOL_PARAM_OVERRIDES = {
    "BTCUSDT": {
        ...
        "ENABLE_CONT_COMP": 0,
        "ENABLE_FAKEOUT": 0,
        "ENABLE_BTC_EXHAUSTION_SHORT": 1,
        "BTC_EXHAUSTION_MIN_STRETCH_ATR": 1.15,
        "BTC_EXHAUSTION_MIN_RSI": 63.0,
        "BTC_EXHAUSTION_MIN_HTF_ADX": 14.0,
        "BTC_EXHAUSTION_MAX_HTF_RSI": 58.0,
        "BTC_EXHAUSTION_MIN_UPPER_WICK_BODY": 0.75,
        "BTC_EXHAUSTION_MIN_CLOSE_POS_FROM_HIGH": 0.55,
        "BTC_EXHAUSTION_RISK_MULTIPLIER": 0.70,
    },
    "ETHUSDT": {
        ...
        "CONTINUATION_PULLBACK_DEPTH_ATR": 0.95,
        "RISK_MULTIPLIER_CONTINUATION": 0.52,
        "BTC_SHORTS_ONLY_STRONG_BEAR": 1,
        "BTC_DISABLE_IMPULSE_SHORT": 1,
        "BTC_DISABLE_FAKEOUT_SHORT": 1,
        "BTC_DISABLE_CONT_COMP_SHORT": 1,
...
# ===== BTC exhaustion short (v10) =====
ENABLE_BTC_EXHAUSTION_SHORT = True
BTC_EXHAUSTION_MIN_STRETCH_ATR = 1.20
BTC_EXHAUSTION_MIN_RSI = 64.0
BTC_EXHAUSTION_MIN_HTF_ADX = 14.0
BTC_EXHAUSTION_MAX_HTF_RSI = 60.0
BTC_EXHAUSTION_MIN_UPPER_WICK_BODY = 0.70
BTC_EXHAUSTION_MIN_CLOSE_POS_FROM_HIGH = 0.55
BTC_EXHAUSTION_RISK_MULTIPLIER = 0.70
