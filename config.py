...
SYMBOL_PARAM_OVERRIDES = {
    "BTCUSDT": {
        ...
        "IMPULSE_BREAKOUT_MIN_BODY_ATR": 0.50,
        "IMPULSE_BREAKOUT_MIN_RANGE_ATR": 0.82,
        "IMPULSE_BREAKOUT_MIN_EXCURSION_ATR": 0.06,
        "REL_STRENGTH_MIN_RATIO": 0.996,
        "REL_STRENGTH_SHORT_MAX_RATIO": 1.004,
        "CONTINUATION_TOUCH_ATR": 0.42,
        "CONTINUATION_MIN_BODY_ATR": 0.24,
        "CONTINUATION_MIN_CLOSE_POS": 0.52,
        "CONTINUATION_MIN_HTF_ADX": 17.0,
        "CONTINUATION_MIN_VOL_RATIO": 0.86,
        "CONTINUATION_RSI_LONG_MIN": 44.0,
        "CONTINUATION_RSI_LONG_MAX": 68.0,
        "CONTINUATION_RSI_SHORT_MIN": 32.0,
        "CONTINUATION_RSI_SHORT_MAX": 56.0,
        "CONTINUATION_PULLBACK_DEPTH_ATR": 1.20,
        "RISK_MULTIPLIER_CONTINUATION": 0.80,
        "CONTINUATION_SOFT_REJECTION": 1.0,
        "RISK_MULTIPLIER_CONT_COMP": 0.85,
        "CONT_COMP_MIN_BODY_ATR": 0.36,
        "CONT_COMP_MIN_RANGE_ATR": 0.72,
        "CONT_COMP_MIN_VOL_RATIO": 0.95,
        "CONT_COMP_MIN_HTF_ADX": 16.5,
        "CONT_COMP_TOUCH_ATR": 0.50,
        "FAKEOUT_RSI_LONG_MAX": 34.0,
        "FAKEOUT_RSI_SHORT_MIN": 66.0,
    },
    "ETHUSDT": {
        ...
        "RISK_MULTIPLIER_CONTINUATION": 0.65,
        "RISK_MULTIPLIER_CONT_COMP": 0.72,
        "CONT_COMP_MIN_BODY_ATR": 0.42,
        "CONT_COMP_MIN_RANGE_ATR": 0.82,
        "CONT_COMP_MIN_VOL_RATIO": 1.00,
    ...
    "SOLUSDT": {
        ...
        "RISK_MULTIPLIER_CONT_COMP": 0.62,
    ...
    "BNBUSDT": {
        ...
        "RISK_MULTIPLIER_CONT_COMP": 0.64,
...
CONTINUATION_MIN_BODY_ATR = 0.38
CONTINUATION_MIN_CLOSE_POS = 0.62
CONTINUATION_MIN_VOL_RATIO = 0.98
CONTINUATION_RSI_LONG_MIN = 48.0
CONTINUATION_RSI_LONG_MAX = 63.0
CONTINUATION_RSI_SHORT_MIN = 37.0
CONTINUATION_RSI_SHORT_MAX = 52.0
RANGE_RSI_LONG_MAX = 28.0
RANGE_RSI_SHORT_MIN = 72.0
...
# ===== v6 additions =====
RISK_MULTIPLIER_FAKEOUT = 0.50
RISK_MULTIPLIER_CONT_COMP = 0.75
