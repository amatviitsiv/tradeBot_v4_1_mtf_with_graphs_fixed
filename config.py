...
BTC_POSITION_RISK_MULTIPLIER = 1.10
ETH_POSITION_RISK_MULTIPLIER = 0.95
...
DIRECTIONAL_SCALING_SYMBOLS = ["BTCUSDT", "ETHUSDT"]
STRONG_SETUP_RISK_MULT = 1.85
VERY_STRONG_SETUP_RISK_MULT = 2.75
STRONG_SETUP_MIN_ADX = 25.0
VERY_STRONG_SETUP_MIN_ADX = 30.0
STRONG_SETUP_MIN_DRIFT_PCT = 0.0070
VERY_STRONG_SETUP_MIN_DRIFT_PCT = 0.0100
STRONG_SETUP_MIN_VOLUME_IMPULSE = 0.82
VERY_STRONG_SETUP_MIN_VOLUME_IMPULSE = 0.94
...
ALT_MEAN_REVERSION_ENABLED = True
ALT_MEAN_REVERSION_SYMBOLS = ["SOLUSDT", "BNBUSDT", "AVAXUSDT"]
ALT_MEAN_REVERSION_ALLOW_IN_TRANSITION = True
ALT_MEAN_REVERSION_ALLOW_IN_RANGE = True
ALT_REV_MIN_STRETCH_ATR = 1.55
ALT_REV_RSI_LONG_MAX = 35.0
ALT_REV_RSI_SHORT_MIN = 65.0
ALT_REV_MIN_CLOSE_POS_LONG = 0.45
ALT_REV_MAX_CLOSE_POS_SHORT = 0.55
ALT_REV_MIN_BODY_RATIO = 0.18
ALT_REV_MIN_VOL_RATIO = 0.92
ALT_REV_RISK_MULTIPLIER = 0.70
POSITION_INITIAL_SL_ATR_MULT_ALT_REVERSION = 2.4
POSITION_TP1_ATR_MULT_ALT_REVERSION = 1.0
POSITION_TP1_CLOSE_FRACTION_ALT_REVERSION = 1.0
POSITION_TIME_STOP_BEFORE_TP1_BARS_ALT_REVERSION = 8
POSITION_TIME_STOP_AFTER_TP1_BARS_ALT_REVERSION = 0

ALT_REV_MAX_HTF_ADX = 24.0
ALT_REV_MAX_LTF_ADX = 28.0
ALT_REV_MIN_ATR_PCT = 0.0018
ALT_REV_REQUIRE_REVERSAL_CANDLE = False
ALT_REV_MIN_WICK_REJECTION = 0.10

# Phase 3: regime protection for alt mean reversion
ALT_REV_MAX_HTF_DRIFT_PCT = 0.0115
ALT_REV_MAX_HTF_EMA_SPREAD_PCT = 0.0115
ALT_REV_MAX_PRICE_TO_HTF_EMA20_PCT = 0.034
ALT_REV_HTF_RSI_MIN = 38.0
ALT_REV_HTF_RSI_MAX = 62.0
ALT_REV_MAX_HTF_ADX_TRANSITION = 22.0
ALT_REV_MAX_LTF_ADX_TRANSITION = 26.0
ALT_REV_TRANSITION_MAX_HTF_DRIFT_PCT = 0.0085
ALT_REV_TRANSITION_MAX_HTF_EMA_SPREAD_PCT = 0.0090
ALT_REV_TRANSITION_MAX_PRICE_TO_HTF_EMA20_PCT = 0.028
ALT_REV_TRANSITION_HTF_RSI_MIN = 42.0
ALT_REV_TRANSITION_HTF_RSI_MAX = 58.0
